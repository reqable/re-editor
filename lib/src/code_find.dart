...
class CodeFindValue {
  ...
  bool operator ==(Object other) {
    ...
    return other is CodeFindValue && other.option == option && other.replaceMode == replaceMode && other.result == result && other.searching == searching;
  }
...
class CodeFindOption {
  ...
  bool operator ==(Object other) {
    ...
    return other is CodeFindOption && other.pattern == pattern && other.caseSensitive == caseSensitive && other.regex == regex;
  }
...
class CodeFindResult {
  ...
  CodeFindResult get previous => copyWith(index: index == 0 ? matches.length - 1 : index - 1);

  CodeFindResult get next => copyWith(index: index == matches.length - 1 ? 0 : index + 1);
  ...
  bool operator ==(Object other) {
    ...
    return other is CodeFindResult && other.index == index && listEquals(other.matches, matches) && other.option == option && other.codeLines.equals(codeLines) && other.dirty == dirty;
  }
...
abstract class CodeFindController extends ValueNotifier<CodeFindValue?> {
  factory CodeFindController(CodeLineEditingController controller, [CodeFindValue? value]) => _CodeFindControllerImpl(controller, value);
