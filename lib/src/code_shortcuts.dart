...
class cursorHoverIntent extends CodeShortcutEditableIntent {
  const cursorHoverIntent({required this.mouseStatus, required this.value, required this.selection, required this.position, required this.layerLink, required this.lineHeight});
  final CodeLineSelection? selection;
  final Offset position;
  final MouseStatus mouseStatus;
...
const Map<CodeShortcutType, List<ShortcutActivator>> _kDefaultMacCodeShortcutsActivators = {
  ...
  CodeShortcutType.cursorMoveLineStart: [SingleActivator(LogicalKeyboardKey.arrowLeft, meta: true), SingleActivator(LogicalKeyboardKey.home)],
  ...
  CodeShortcutType.cursorMovePageStart: [SingleActivator(LogicalKeyboardKey.arrowUp, meta: true), SingleActivator(LogicalKeyboardKey.home, control: true)],
  CodeShortcutType.cursorMovePageEnd: [SingleActivator(LogicalKeyboardKey.arrowDown, meta: true), SingleActivator(LogicalKeyboardKey.end, control: true)],
  CodeShortcutType.cursorMoveWordBoundaryForward: [SingleActivator(LogicalKeyboardKey.arrowLeft, alt: true)],
  CodeShortcutType.cursorMoveWordBoundaryBackward: [SingleActivator(LogicalKeyboardKey.arrowRight, alt: true)],
  ...
  CodeShortcutType.selectionExtendPageStart: [SingleActivator(LogicalKeyboardKey.arrowUp, shift: true, meta: true), SingleActivator(LogicalKeyboardKey.home, shift: true, meta: true)],
  CodeShortcutType.selectionExtendPageEnd: [SingleActivator(LogicalKeyboardKey.arrowDown, shift: true, meta: true), SingleActivator(LogicalKeyboardKey.end, shift: true, meta: true)],
  CodeShortcutType.selectionExtendLineStart: [SingleActivator(LogicalKeyboardKey.arrowLeft, shift: true, meta: true), SingleActivator(LogicalKeyboardKey.home, shift: true)],
  CodeShortcutType.selectionExtendLineEnd: [SingleActivator(LogicalKeyboardKey.arrowRight, shift: true, meta: true), SingleActivator(LogicalKeyboardKey.end, shift: true)],
  CodeShortcutType.selectionExtendWordBoundaryForward: [SingleActivator(LogicalKeyboardKey.arrowLeft, shift: true, alt: true)],
  CodeShortcutType.selectionExtendWordBoundaryBackward: [SingleActivator(LogicalKeyboardKey.arrowRight, shift: true, alt: true)],
...
const Map<CodeShortcutType, List<ShortcutActivator>> _kDefaultCommonCodeShortcutsActivators = {
  ...
  CodeShortcutType.cursorMoveForward: [SingleActivator(LogicalKeyboardKey.arrowRight)],
  CodeShortcutType.cursorMoveBackward: [SingleActivator(LogicalKeyboardKey.arrowLeft)],
  CodeShortcutType.cursorMoveLineStart: [SingleActivator(LogicalKeyboardKey.arrowLeft, control: true), SingleActivator(LogicalKeyboardKey.home)],
  CodeShortcutType.cursorMoveLineEnd: [SingleActivator(LogicalKeyboardKey.arrowRight, control: true), SingleActivator(LogicalKeyboardKey.end)],
  CodeShortcutType.cursorMovePageStart: [SingleActivator(LogicalKeyboardKey.arrowUp, control: true), SingleActivator(LogicalKeyboardKey.home, control: true)],
  CodeShortcutType.cursorMovePageEnd: [SingleActivator(LogicalKeyboardKey.arrowDown, control: true), SingleActivator(LogicalKeyboardKey.end, control: true)],
  CodeShortcutType.cursorMoveWordBoundaryForward: [SingleActivator(LogicalKeyboardKey.arrowLeft, alt: true)],
  CodeShortcutType.cursorMoveWordBoundaryBackward: [SingleActivator(LogicalKeyboardKey.arrowRight, alt: true)],
  CodeShortcutType.selectionExtendUp: [SingleActivator(LogicalKeyboardKey.arrowUp, shift: true)],
  CodeShortcutType.selectionExtendDown: [SingleActivator(LogicalKeyboardKey.arrowDown, shift: true)],
